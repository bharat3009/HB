...
public class CommentsController {
    ...
    @RequestMapping(value = "getallcommentsbyarea", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseBody
    public String getAllCommentsByArea(@RequestParam("areaId") String areaId) {
        ...
        try {
            ...
            // This is call service to get comment for specific user.
            List<CommentDTO> commentsDtoList = commentsService.getCommentsListByAreaId(areaId);
            return JsonUtility.getJson(ErrorCodes.GA_TRANSACTION_OK, commentsDtoList);
        } catch (GAException e) {
            if (e.getCode() == ErrorCodes.GA_DATA_NOT_FOUND.getErrorCode()) {
                return JsonUtility.getJson(ErrorCodes.GA_DATA_NOT_FOUND, null);
