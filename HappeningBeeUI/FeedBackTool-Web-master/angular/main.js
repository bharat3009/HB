...
feedbackApp.constant('userConst', 'http://http://feedbacktool-env.elasticbeanstalk.com/user/');
feedbackApp.constant('commentConst', 'http://http://feedbacktool-env.elasticbeanstalk.com/comments/');
